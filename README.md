...
- [x402 Finance API](https://x402-paid-api.x402-finance.workers.dev) - Live crypto market data (BTC/ETH/SOL at **$0.002 USDC**), Token Safety analysis (**$0.04 USDC**), and Holder Cluster analysis (**$0.01 USDC**). Native x402 V2 on Base Mainnet with Coinbase CDP Facilitator. Includes discovery, llms.txt, and MCP tool definitions. ([llms.txt](https://x402-paid-api.x402-finance.workers.dev/llms.txt)) ([MCP Tools](https://x402-paid-api.x402-finance.workers.dev/mcp-tools.json)) ([Discovery](https://x402-paid-api.x402-finance.workers.dev/.well-known/x402.json))
